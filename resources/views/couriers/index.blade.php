...
<div class="ck-wrap">
    ...
    <div class="admin-hero">
        <div class="admin-hero-left">
            <div class="admin-hero-icon"><i class="fa fa-truck"></i></div>
            <div>
                <h1 class="admin-hero-title">Manajemen Kurir</h1>
                <p class="admin-hero-sub">Kelola layanan kurir dan tarif pengiriman</p>
            </div>
        </div>
        <div class="admin-hero-stats">
            <div class="admin-hero-stat">
                <div class="admin-hero-stat-num">{{ $stats['total'] }}</div>
                <div class="admin-hero-stat-label">Total Kurir</div>
            </div>
            <div class="admin-hero-stat">
            ...
            <div class="admin-hero-stat">
                <div class="admin-hero-stat-num" style="color:#93c5fd;">{{ $stats['services'] }}</div>
                <div class="admin-hero-stat-label">Layanan</div>
            </div>
        </div>
