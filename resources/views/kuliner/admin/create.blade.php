...
.kl-form-header { padding: 22px 28px; border-bottom: 1px solid #f2f2f5; display: flex; align-items: center; gap: 12px; }
.kl-form-header-icon { width: 44px; height: 44px; border-radius: 11px; background: linear-gradient(135deg, #ffe4b2, #fff7e6); display: flex; align-items: center; justify-content: center; font-size: 18px; color: #d97706; flex-shrink: 0; }
...
.kl-label { font-size: 12px; font-weight: 700; color: #555; display: flex; align-items: center; gap: 4px; }
...
.kl-upload-placeholder { display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 32px; gap: 8px; }
.kl-upload-placeholder i { font-size: 36px; color: #d1d5db; }
...
.kl-img-preview { width: 100%; height: 220px; object-fit: cover; display: none; }

/* Time grid */
.kl-time-group { display: flex; align-items: center; gap: 10px; }
.kl-time-sep { font-size: 13px; color: #9ca3af; font-weight: 700; flex-shrink: 0; margin-top: 2px; }
...
<div class="kl-form-wrap">
    <div class="kl-page-header">
        <h1 class="kl-page-title"><i class="fa fa-plus-circle"></i> Tambah Warung Kuliner</h1>
    ...
    <div class="kl-form-card">
        <div class="kl-form-header">
            <div class="kl-form-header-icon"><i class="fa fa-cutlery"></i></div>
            <div>
        ...
        <form action="{{ route('admin.kuliner.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="kl-form-body">
                ...
                <div class="kl-form-section">
                    ...
                    <div class="kl-form-grid">
                        <div class="kl-form-group full">
                            ...
                            <input type="text" name="nama" class="kl-input" value="{{ old('nama') }}" placeholder="cth: Warung Nasi Ibu Sari">
                        ...
                        <div class="kl-form-group full">
                            ...
                            <textarea name="deskripsi" class="kl-textarea" placeholder="Ceritakan tentang warung ini, menu andalan, suasana, dll...">{{ old('deskripsi') }}</textarea>
                ...
                <div class="kl-form-section">
                    ...
                    <div class="kl-upload-area" id="uploadArea" onclick="document.getElementById('gambarInput').click()">
                        <img id="imgPreview" class="kl-img-preview" src="" alt="Preview">
                        <div class="kl-upload-placeholder" id="imgPlaceholder">
                            <i class="fa fa-cloud-upload"></i>
                            <span>Klik untuk upload foto warung</span>
                ...
                <div class="kl-form-section">
                    ...
                    <div class="kl-form-grid">
                        <div class="kl-form-group full">
                            ...
                            <input type="text" name="alamat" class="kl-input" value="{{ old('alamat') }}" placeholder="cth: Jl. Raya Manud Jaya No. 12, RT 02/RW 01">
                        ...
                        <div class="kl-form-group">
                            ...
                            <div class="kl-time-group">
                                <input type="time" name="jam_buka" class="kl-input" value="{{ old('jam_buka') }}" style="flex:1">
                                <span class="kl-time-sep">–</span>
                                <input type="time" name="jam_tutup" class="kl-input" value="{{ old('jam_tutup') }}" style="flex:1">
                            </div>
                        ...
                        <div class="kl-form-group">
                            ...
                            <input type="text" name="kontak_wa" class="kl-input" value="{{ old('kontak_wa') }}" placeholder="cth: 6281234567890">
                        ...
                        <div class="kl-form-group full">
                            ...
                            <input type="url" name="link_maps" class="kl-input" value="{{ old('link_maps') }}" placeholder="https://maps.google.com/...">
            ...
            <div class="kl-form-footer">
                ...
                <button type="submit" class="kl-submit-btn"><i class="fa fa-save"></i> Simpan Warung</button>
            </div>
        </form>
    </div>
</div>
