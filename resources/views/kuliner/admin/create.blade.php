...
.kl-img-preview { width: 100%; height: 160px; border-radius: 10px; background: #f5f5f5; border: 2px dashed #e5e7eb; display: flex; align-items: center; justify-content: center; overflow: hidden; margin-bottom: 8px; cursor: pointer; transition: border-color .2s; }
    ...
    <div class="kl-form-card">
        <form action="{{ route('admin.kuliner.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="kl-form-section">
                ...
                <div class="kl-form-grid">
                    ...
                    <div class="kl-form-group full">
                        ...
                        <textarea name="deskripsi" class="kl-textarea" placeholder="Ceritakan tentang warung ini...">{{ old('deskripsi') }}</textarea>
            ...
            <div class="kl-form-section">
                ...
                <div class="kl-hint">Format: JPG, JPEG, PNG. Maksimal 2MB.</div>
            ...
            <div class="kl-form-section">
                ...
                <div class="kl-form-grid">
                    ...
                    <div class="kl-form-group">
                        ...
                        <input type="time" name="jam_buka" class="kl-input" value="{{ old('jam_buka') }}">
                        @error('jam_buka')<div class="kl-error">{{ $message }}</div>@enderror
                    </div>
                    <div class="kl-form-group">
                        <label class="kl-label">Jam Tutup <span class="req">*</span></label>
                        <input type="time" name="jam_tutup" class="kl-input" value="{{ old('jam_tutup') }}">
