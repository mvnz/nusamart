...
.cat-populer-right { flex: 1; padding: 20px 24px; }
.cat-populer-heading { font-size: 16px; font-weight: 800; color: #1a1b28; margin-bottom: 16px; }
.cat-chips-grid {
    display: grid;
...
.cat-chip:hover { background: #fff0f2; border-color: #D10024; color: #D10024; }
.cat-chip-icon {
